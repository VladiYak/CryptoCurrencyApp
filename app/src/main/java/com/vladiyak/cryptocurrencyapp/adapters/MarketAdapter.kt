...
import com.vladiyak.cryptocurrencyapp.databinding.CurrencyItemLayoutBinding
import com.vladiyak.cryptocurrencyapp.fragments.FavoriteFragmentDirections
import com.vladiyak.cryptocurrencyapp.fragments.HomeFragmentDirections
import com.vladiyak.cryptocurrencyapp.fragments.MarketFragmentDirections
    ...
    override fun onBindViewHolder(holder: MarketViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            if (type == "home") {
                ...
                Navigation.findNavController(it).navigate(
                    FavoriteFragmentDirections.actionFavoriteFragmentToDetailsFragment(item)
                )
            }
        }
    }
